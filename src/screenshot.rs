...
// use egui::{Color32, ColorImage, Id, Image, ImageSource, Pos2, Rect, Response, Sense, Shape, Stroke, Ui, Vec2};
...
// //     mouse_original_selection_rect: Option<MouseSelectionRect>,
// // 
// // 
// //     // 选择状态
// //     selection_rect: Option<Rect>,
// //     mouse_selection_rect: Option<MouseSelectionRect>,
// //     is_selecting: bool,
...
// // 
// //     screen_with: i32, // 屏幕宽度
// //     screen_height: i32, // 屏幕高度
// // }
// // 
...
//                             ui.horizontal(|ui| {
//                                 // 工具选择
//                                 let file_data = fs::read("icon/pen.png").ok().unwrap();
...
//                                 ImageSource::load(ctx, &color_image)
//                                 let image_resouce = ctx.load_texture("loaded_image", color_image, egui::TextureOptions::LINEAR);
//                                 self.selectable_label_with_icon(ui, Tool::Pen, image_buffer, "");
//                                 self.tool_button(ui, Tool::MoveBox, "↔").hovered();
//                                 self.tool_button(ui, Tool::Pen, "✏").hovered();
//                                 self.tool_button(ui, Tool::Rectangle, "□").hovered();
//                                 self.tool_button(ui, Tool::Arrow, "⬈").hovered();
//                                 self.tool_button(ui, Tool::Text, "T").hovered();
// 
//                                 ui.separator();
// 
//                                 // 颜色选择
...
//     }
// 
//     fn tool_button(&mut self, ui: &mut Ui, tool: Tool, icon: &str) -> egui::Response {
...
//     }
// 
//     fn selectable_label_with_icon(&mut self, ui: &mut Ui, tool: Tool, icon: ImageSource, text: &str) -> Response {
//         let is_selected = self.current_tool == tool;
//         ui.horizontal(|mut ui| {
//             // 创建圆形图标
//             let icon_size = Vec2::splat(16.0); // 正方形尺寸
//             let (rect, response) = ui.allocate_exact_size(icon_size, Sense::click());
// 
//             // 绘制圆形背景（可选）
//             if is_selected {
//                 let painter = ui.painter();
//                 painter.circle_filled(rect.center(), rect.width() / 2.0, Color32::LIGHT_BLUE);
//             }
// 
//             // 绘制图标
//             Image::new(icon)
...
// 
//             // 添加文本
//             let text_response = ui.selectable_label(is_selected, text);
